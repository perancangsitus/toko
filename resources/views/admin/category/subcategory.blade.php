  ...
  <a href="#" class="btn btn-sm btn-info" style="float: right;" data-toggle="modal" data-target="#modaldemo3">Tambah</a>
          </h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Nama Katagori</th>
                  <th class="wd-15p">Nama Sub Katagori</th>
        ...
        <div class="form-group">
          <label for="exampleInputEmail1">Category Name</label>
           <select class="form-control" name="category_id">
            ...
            <option value="{{ $item->id }}"> {{ $item->categtory_name }}  </option> 
            @endforeach
